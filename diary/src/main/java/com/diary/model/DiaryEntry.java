...
public class DiaryEntry {
    ...
    /**
     * Retrieves the date edited.
     * 
     * @return Date edited as a LocalDateTime.
     */
     ...
     * 
     * @param dateEdited New date edited to set.
     */
    ...
    /**
     * * Sets new title for the diary entry.
     * 
    ...
    /**
     * * Sets new mood for the diary entry.
     * 
     * @param mood New mood to set.
     */
    ...
    /**
     * * Sets new location for the diary entry.
     * 
    ...
    /**
     * * Sets new public content for the diary entry.
     * 
     * @param publicContent New public content to set.
     */
    ...
    /**
     * * Sets new encoded content for the diary entry.
     * 
     * @param encodedContent New encoded content to set.
     */
    ...
    /**
     * * Sets new encrypted status for the diary entry.
     * 
     * @param encrypted New encrypted status to set.
     */
