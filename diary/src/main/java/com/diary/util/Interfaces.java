...
public class Interfaces {
    ...
    public static void showOtherEntry(String entryId, List<DiaryEntry> entries) {
        ...
        if (entry.getEncrypted()) {
            ...
            System.out.println("| Content: " + entry.getPublicContent());
        }
        System.out.println("================================");
    }
     ...
     */
    public static void messageGetEntryByIdTestSuccess() {
        System.out.println("\n===== Diary entry retrieved successfully by ID! =====");
    }

    public static void messageNoProperFieldInputCheck() {
        System.out.println("\n===== Entries can be made with improper field input! =====");
    }

    // headings, or short prompts that require multiple lines
    /** * Prompt message for diary text input. */
    public static void messageDiaryEntries() {
        System.out.println("~~~~ Diary Entries ~~~~");
    }

    /** * Prompt user to create or login. */
    public static void messageUserCreateOrLogin() {
        System.out.print("\n\n\n~~~~ Choose action ~~~~\n|1| Create new user\n|2| Login\n|~| ");
    }

    /** * Informational message for creating a new diary entry. */
    public static void messagecreatingEntry() {
        System.out.println("\n\n\n~~~~~~ Creating a new diary entry ~~~~~~");
    }

    /** * Prompt message for diary content input. */
    public static void messagePromptContent() {
        System.out.print("~~~~| Enter diary content (type 'END' on a new line to finish) |~~~~");
    }

    /** * Prompt message for encryption choice. */
    public static void messagePromptEncryptionChoice() {
        System.out.print("~~~~| do you want to encrypt the content? |~~~~\n|1| No\n|2| Yes\n|~| ");
    }
